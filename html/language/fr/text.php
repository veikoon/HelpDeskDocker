...
$hesklang['EMAIL_HR']='------ Répondre au-dessous de cette ligne ------';
...
&quot;Hardware problèmes&quot;, &quot;PHP/MySQL problèmes&quot; etc) et pour assigner des utilisateurs à des catégories (par exemple l\'utilisateur ne pourra voir que les tickets de cette catégorie )';
...
$hesklang['err_dbhost']='Saisir le MySQL database host';
$hesklang['err_dbname']='Saisir le MySQL database nom';
$hesklang['err_dbuser']='Saisir le MySQL database username';
$hesklang['err_dbpass']='Saisir le MySQL database password';
...
$hesklang['d_ci']='AMINISTRATION: format de date PHP valide, voir le manuel PHP.';
...
$hesklang['cf_limit']='Vous avez créé 50 champs personnalisés, vous ne pouvez plus en créer de nouveaux.';
...
$hesklang['ticket_escalated']='[#%%TRACK_ID%%] ESCALADE : %%SUBJECT%%';
$hesklang['escalate']['tab']='Escalade'; // Menu link
...
$hesklang['escalate']['prefix']='Escalade :'; // Email subject prefix, e.g. "Escalated: [XXX-XXX-XXXX] Test ticket"
$hesklang['escalate']['active_rules']='Règles actives';
$hesklang['escalate']['new']='Nouvelle règle descalade';
$hesklang['escalate']['no_rules']='Vous avez aucune règle descalade. Créez-en une en cliquant sur "Nouvelle règle descalade" bouton ci-dessus.';
...
$hesklang['escalate']['edit']='Modification de ID de règle descalade %1$s'; // %1$s = rule ID number
...
$hesklang['escalate']['tic']='Billets dans la catégorie :';
...
$hesklang['escalate']['edit_notice']='la modification du déclencheur de la règle aura aucun effet sur les tickets déjà escaladés par cette règle (sauf si vous réinitialisez la règle).';
$hesklang['escalate']['reset']='Réinitialiser cette règle';
$hesklang['escalate']['reset2']='Êtes-vous sûr de vouloir réinitialiser cette règle ?<br><br>Les réponses aux règles passeront à 0 et tout ticket correspondant à cette règle sera à nouveau escaladé.';
...
$hesklang['escalate']['thist1']='<li class="smaller">%1$s | escaladé par %2$s :</li>'; // Used in ticket history log. %1$s = date, %2$s = rule log title (above)
...
$hesklang['escalate']['thist7']='<li class="smaller">%1$s | - erreur : %2$s n\'a pas la permission de voir les billets</li>'; // %1$s = date, %2$s = owner
...
$hesklang['escalate']['no_active']='Aucune règle descalade active';
...
$hesklang['escalate']['tbef']='Avant une règle ne soit active, vous devez activer en cliquant sur la case à cocher dans le champ "ACTIVE" colonne.<br><br>
                               ...
                               <strong>Les règles actives sont traitées toutes les %2$s minutes. Un ticket ne peut être escaladé une seule fois par chaque règle</strong>.'; // %1$s = replaced by icon, %2$s = number of minutes, usually 5 or more
...
$hesklang['due_date_updated']='La date d\'échéance du billet a été mise à jour.';
...
$hesklang['ql_all']='Tous les billets';
...
$hesklang['overdue_ticket_count']='Trouvé %s billets en retard.'; // %s = Number of tickets
